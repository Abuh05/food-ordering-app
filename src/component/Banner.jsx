  ...
  return (
    <div className='banner w-full md:w-2/3 px-7 mx-auto relative flex items-center justify-between'>
        <div className='banner-description w-full md:w-1/2 p-3'>
            <h2 className='mb-6 text-5xl font-bold text-indigo-600'>Food Ordering Made Easy</h2>
        ...
        <div className='banner-image w-full md:w-1/2 px-3 flex justify-end'>
      <img src={require("../assets/images/pizza_banner.png")} alt="banner" className='max-h-70' />
        </div>
    </div>
  )
}
